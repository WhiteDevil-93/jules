...
| 機能                   | 説明                                                                                                                                                                                             | コマンド / アイコン                      |
| :--------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------- |
| **APIキーの設定**      | 初回利用時にAPIキーを設定してJulesアカウントに接続します。キーはVSCodeのSecretStorageに安全に保存されます。                                                                                             | `Jules: Set Jules API Key`               |
...
| **セッション管理**     | `Jules: Create Jules Session`コマンドで新しいタスクを割り当てます。過去のセッションの再開や履歴の確認も可能です。                                                                                             | `Jules: Create Jules Session`            |
