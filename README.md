...
| **Open Settings**        | Open the settings for the Jules extension.                                                                                                                                                                         | `jules-extension.openSettings`      |
| **Delete Session**       | Delete a session from the local cache.                                                                                                                                                                             | `jules-extension.deleteSession`     |
| **Set GitHub Token**     | Set your GitHub Personal Access Token for checking PR status.                                                                                                                                                      | `jules-extension.setGithubToken`    |
| **Clear Cache**          | Clear the Jules extension cache.                                                                                                                                                                                   | `jules-extension.clearCache`        |
| **Sign in to GitHub**    | Sign in to your GitHub account.                                                                                                                                                                                    | `jules-extension.signInGitHub`      |
...
- `Jules: Delete Session from Local Cache` - Delete a session from the local cache
- `Jules: Set GitHub Token (for PR Status)` - Set the GitHub token for PR status checking
- `Jules: Clear Jules Cache` - Clear the extension cache
- `Jules: Sign in to GitHub` - Sign in to GitHub
- `Jules: [DEPRECATED] Set GitHub PAT` - Set the GitHub PAT (deprecated)
